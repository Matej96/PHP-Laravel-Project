        ...
        <div class="container-fluid">
            <div class="col-md-1 col-2 me-">
                <a href="<?php echo e(url('/')); ?>">
                    <img class="navbar-brand  text-center" src=<?php echo e(asset('images/wtech_logo.png')); ?>>
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <div id="ss" class="search_div">
                    <form method="get" action="<?php echo e(route('search_list')); ?>" class="d-flex me-4 formik">
            ...
            <form method="get" action="<?php echo e(route('search_list')); ?>" class="d-flex me-4">
                <input class="form-control me-2 " name="search" type="search" placeholder="Vyhľadať tovar" aria-label="Search">
                <button class="btn btn-outline-success " type="submit"><i class="bi bi-search">
                        <span class="d-md-none"></span>
                    </i></button>
            ...
            <div class="row">
                <div class="col-4 mt-3">
                    <ul class="multi-column-dropdown">
                        <span class="title-section">Oblečenie</span>
                        <hr style="height: 2px;box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">
                        <li><a href="<?php echo e(route('product_list.index', ['id' => 4])); ?>">Mikiny</a></li>
                        <li><a href="<?php echo e(route('product_list.index', ['id' => 4])); ?>">Nohavice</a></li>
                        <li><a href="product_list_page.html">Bundy</a></li>
                        <li><a href="product_list_page.html">Tričká</a></li>
                    </ul>
                </div>
...
<?php /**PATH C:\Users\matej\OneDrive\Počítač\Škola\6. semester\WTECH\WTECH\WearIt\resources\views/layout/partials/header.blade.php ENDPATH**/ ?>