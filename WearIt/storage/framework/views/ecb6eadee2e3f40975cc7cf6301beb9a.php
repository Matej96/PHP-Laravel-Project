<?php $__env->startSection('custom'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/style_product_list.css')); ?>">
            ...
            <div class="row py-3">
                ...
                <div class="col-lg-10 col" id="main">
                    <div class="container-fluid main_container">
                        ...
                        <form method="get" action="<?php echo e(route('filtered_list', ['id' => $data['category_id']])); ?>">
                                    ...
                                    <div class="form-group mb-4">
                                        <select class="selectpicker border-dark" name="colors[]" id="colorPicker" title="Farba" multiple
                                            ...
                                            <?php $__currentLoopData = $data['colors']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($color->color_name); ?>" data-content="<span class='circle
                                                #00ff00'></span><?php echo e($color->color_name); ?>"></option>
                                ...
                                <div class="col-6 col-md-3 dropdown_div">
                                    <div class="form-group mb-4">
                                        <select class="selectpicker border-dark" name="sizes[]" data-size="10" id="sizePicker" title="Veľkosť" multiple
                                                aria-label="size 3 select example">
                                            <?php $__currentLoopData = $data['sizes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($size->size_name); ?>" data-content="<?php echo e($size->size_name); ?>"></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div>
                                ...
                                <?php echo e(count($data['products'])); ?>
                                ...
                                <div class="swiper-slide">
                                    <div class="grid-container">
                                        <?php $__currentLoopData = $data['products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="grid-item">
                                                <div class="img_box">
                                                    <a href="<?php echo e(route('product_page', ['id' => $product->id])); ?>">
                                                        <img src="<?php echo e(asset($product->product_image)); ?>">
                                                    </a>
                                                </div>
                                                <div class="content">
                        ...
                        <div >
                            <?php echo e($data['products']->links('vendor.pagination.bootstrap-4')); ?>
...
<?php $__env->startSection('customJs'); ?>
    ...
    <script src="<?php echo e(asset('js/script_product_list_page.js')); ?>"></script>
    <script src="<?php echo e(asset('js/navbar.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\matej\OneDrive\Počítač\Škola\6. semester\WTECH\WTECH\WearIt\resources\views/product_list.blade.php ENDPATH**/ ?>